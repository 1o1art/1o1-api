...
export interface DiamondLoupeFacetInterface extends utils.Interface {
  functions: {
    ...
    "facetIdsFromAddresses(address[])": FunctionFragment;
    "facetResolveGlobalAddress(bytes20,bytes4)": FunctionFragment;
    "facetResolveGlobalAddress(bytes20[],bytes4)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "facetResolveGlobalAddress(bytes20,bytes4)"
      | "facetResolveGlobalAddress(bytes20[],bytes4)"
      | "facets"
      | "supportsInterface"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "facetIdsFromAddresses",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "facetResolveGlobalAddress(bytes20,bytes4)",
...
export interface DiamondLoupeFacet extends BaseContract {
  ...
  functions: {
    ...
    "facetResolveGlobalAddress(bytes20[],bytes4)"(
      _facetIds: PromiseOrValue<BytesLike>[],
      _functionSelector: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[string] & { facetAddress_: string }>;
